...
function galleryElemTemplate( {preview, original, description} ) {
...
let modalBox = new SimpleLightbox('.gallery a',{ captionsData: `alt`, captionsDelay: 250 });

modalBox.on('shown.simplelightbox', function () {
